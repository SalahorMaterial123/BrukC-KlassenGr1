...
namespace KlassenGr1
{
    internal class Gymnasium : Schuler
    {
        ...
        { this.alterDirektor=alterDirektor;}*/
        //Methode 1 
        public virtual void erfahrung(bool berufserfahrung)
        {
            if (berufserfahrung)
            {
        ...
        //Methode 3 mit override
        public override void mancareFreuTraurig()
        {
            if (getMancare() == true)
                Console.WriteLine("Direktor " + NameDirektor + " promovat.");
            else
                Console.WriteLine("Direktor " + NameDirektor + " nepromovat.");
        }
    }
}
